...
export const examples: ExampleConfig[] = [
  ...
  },
  {
    ...
    category: 'Validation',
    config: { validIncrement: 5, keyIncrement: 5, snapOrigin: 0 },
    controls: [
      { type: 'input', key: 'min', label: 'Min', inputType: 'number', placeholder: 'No min' },
      { type: 'input', key: 'max', label: 'Max', inputType: 'number', placeholder: 'No max' },
      { type: 'input', key: 'validIncrement', label: 'Valid Increment', inputType: 'number', placeholder: '0', sign: 'positive' },
      { type: 'input', key: 'keyIncrement', label: 'Key Increment', inputType: 'number', placeholder: '1', sign: 'positive' },
      { type: 'input', key: 'snapOrigin', label: 'Snap Origin', inputType: 'number', placeholder: '0' },
      { type: 'input', key: 'validationTimeout', label: 'Timeout (ms)', inputType: 'number', placeholder: '500', sign: 'positive' },
    ],
  },
  {
    id: 'currency',
    ...
    category: 'Formatting',
    config: { prefix: '$', decimalSeparator: '.', separators: ',', min: 0 },
    controls: [
      ...
      { type: 'select', key: 'decimalSeparator', label: 'Decimal', options: decimalOptions },
      { type: 'input', key: 'keyIncrement', label: 'Key Increment', inputType: 'number', placeholder: '1', sign: 'positive' },
      { type: 'input', key: 'min', label: 'Min', inputType: 'number', placeholder: 'No min' },
      { type: 'input', key: 'max', label: 'Max', inputType: 'number', placeholder: 'No max' },
      { type: 'input', key: 'validIncrement', label: 'Valid Increment', inputType: 'number', placeholder: '0.01', sign: 'positive' },
    ],
  },
  {
    id: 'percentage',
  ...
  },
  {
    ...
    category: 'Input',
    config: { decimalKeys: 'both', decimalSeparator: ',' },
    controls: [
      { type: 'select', key: 'decimalKeys', label: 'Decimal Keys', options: decimalKeysOptions },
      { type: 'select', key: 'decimalSeparator', label: 'Decimal Char', options: decimalOptions },
      { type: 'select', key: 'separators', label: 'Separators', options: separatorOptions },
    ],
  },
  {
    ...
    category: 'Input',
    config: { decimalSeparator: '.', separators: ',' },
    controls: [
      { type: 'select', key: 'decimalSeparator', label: 'Decimal Char', options: decimalOptions },
      { type: 'select', key: 'separators', label: 'Separators', options: separatorOptions },
  ...
  },
  {
    ...
    category: 'Locale',
    config: { locale: 'de-DE', decimalSeparator: ',', separators: '.' },
    controls: [
      { type: 'select', key: 'locale', label: 'Locale', options: localeOptions },
      { type: 'select', key: 'separators', label: 'Separators', options: separatorOptions },
      { type: 'select', key: 'decimalSeparator', label: 'Decimal', options: decimalOptions },
  ...
  },
  {
    ...
    category: 'Validation',
    config: { validIncrement: 0.01, keyIncrement: 0.01, decimalSeparator: '.' },
    controls: [
      { type: 'input', key: 'validIncrement', label: 'Valid Increment', inputType: 'number', placeholder: '0.01', sign: 'positive' },
      { type: 'input', key: 'keyIncrement', label: 'Key Increment', inputType: 'number', placeholder: '0.01', sign: 'positive' },
      { type: 'select', key: 'decimalSeparator', label: 'Decimal', options: decimalOptions },
      { type: 'toggle', key: 'integer', label: 'Integer Only' },
    ],
  },
